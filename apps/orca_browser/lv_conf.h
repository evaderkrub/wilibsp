...
#define LV_USE_DRAW_SW 1
     ...
     */
    /* RP2350B copy_to_ram budget: keep only formats this project uses.
       RGB565 = display wire format; ARGB8888 = LVGL internal (gradients, theme).
       Everything else is dead weight when code lives in SRAM. */
    #define LV_DRAW_SW_SUPPORT_RGB565               1
    #define LV_DRAW_SW_SUPPORT_RGB565_SWAPPED       0  /* swap done in flush_cb, not by LVGL */
    #define LV_DRAW_SW_SUPPORT_RGB565A8             1
    #define LV_DRAW_SW_SUPPORT_RGB888               0  /* unused; saves ~12 KB */
    #define LV_DRAW_SW_SUPPORT_XRGB8888             0  /* unused; saves code */
    #define LV_DRAW_SW_SUPPORT_ARGB8888             1  /* needed by default theme */
    #define LV_DRAW_SW_SUPPORT_ARGB8888_PREMULTIPLIED 0 /* unused; saves ~12 KB */
    #define LV_DRAW_SW_SUPPORT_L8                   0  /* unused; saves ~8 KB */
    #define LV_DRAW_SW_SUPPORT_AL88                 0  /* unused */
    #define LV_DRAW_SW_SUPPORT_A8                   0  /* unused */
    #define LV_DRAW_SW_SUPPORT_I1                   0  /* unused; saves ~12 KB */
